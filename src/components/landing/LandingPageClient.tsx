          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-xs">
                Learn From YouTube Courses with interactive learning experience with AI-powered notes, quizzes, and tutoring.
              </p>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-border">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6">
                <Link href="https://github.com/Avinash1286/ecastacademy" className="text-muted-foreground hover:text-foreground transition-colors">
