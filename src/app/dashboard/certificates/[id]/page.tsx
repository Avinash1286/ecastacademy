...
import { Award, Calendar, Download, GraduationCap, TrendingUp, CheckCircle } from "lucide-react"
            ...
            <div className="border-t-2 border-amber-200 dark:border-amber-800 pt-8 mt-8">
              ...
              <div className="mt-8 pt-6 border-t border-border/50 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  This certificate can be verified at ecastacademy.com/certificates/{certificate.certificateId}
                </p>
              </div>
            </div>
          </CardContent>
...
function CertificateViewSkeleton() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-50/30 dark:from-amber-950/10 dark:via-background dark:to-amber-950/5 py-12 px-4">
      <div className="container mx-auto max-w-5xl">
